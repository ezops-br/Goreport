...
@click.option('--lang', type=click.STRING, is_flag=False, help="Language of the report. Defaults to 'en'.")
@click.pass_context
def parse_options(self, id, format, template, combine, complete, config, google, verbose, filename, lang):
    ...
    gophish = goreport.Goreport(format, config, google, verbose, template, filename, lang)
